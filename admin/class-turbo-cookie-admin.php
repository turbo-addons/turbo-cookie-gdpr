...
class Turbo_Cookie_Admin {
	...
	public function ajax_save_banner() {
		...
		$banner = array(
			...
			'btn_decline_bg'      => Turbo_Cookie::sanitize_css_color( wp_unslash( $_POST['btn_decline_bg'] ?? 'transparent' ), 'transparent' ),
			...
			'btn_prefs_bg'        => Turbo_Cookie::sanitize_css_color( wp_unslash( $_POST['btn_prefs_bg'] ?? 'transparent' ), 'transparent' ),
